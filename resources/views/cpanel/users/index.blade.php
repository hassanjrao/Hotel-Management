                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group" role="group" aria-label="Horizontal Primary">
                                            ...
                                            <a href="{{ route('cpanel.users.edit', $user->id) }}"
                                                class="btn btn-sm btn-alt-primary">Edit</a>
                                            <form id="form-{{ $user->id }}"
                                                action="{{ route('cpanel.users.destroy', $user->id) }}" method="POST">
                                                @method('DELETE')
                                                @csrf
    ...
    <div class="modal fade" id="modal-block-popin" role="dialog" aria-labelledby="modal-block-popin" aria-hidden="true">
        <div class="modal-dialog modal-dialog-popin" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('cpanel.users.store') }}" method="POST" enctype="multipart/form-data">
